...
_axiosDefault.default.get('https://restcountries.com/v2/all?fields=name,region,flags,population');
async function fetchCountryFacts() {
    try {
        const result = await _axiosDefault.default.get('https://restcountries.com/v2/all?fields=name,region,flag,population');
...
function countryRegion(country) {
    if (country === 'Africa') return 'Blue';
    else if (country === 'Americas') return 'Green';
    else if (country === 'Asia') return 'Red';
    else if (country === 'Europe') return 'Yellow';
    else if (country === 'Oceania') return 'Purple';
}
